...
{
    public class LoadDepartamentoService
    {
        public const string CLASSNAME = "Lista de Departamentos";
        internal static List<Departamento> GetData()
        {
            ...
            using (var connection = OracleProvider.GetConnection())
            {
                ...
                var resultado = connection.Query<Departamento>(@"SP_SELECTDPTO"
                                            , p
